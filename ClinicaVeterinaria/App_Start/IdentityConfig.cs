...
using static ClinicaVeterinaria.Models.ApplicationUser;
...
namespace ClinicaVeterinaria
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        public ApplicationUserManager(IUserStore<ApplicationUser> store)
            : base(store)
        {
            this.UserTokenProvider = new DataProtectorTokenProvider<ApplicationUser>(new DpapiDataProtectionProvider("ClinicaVeterinaria").Create("TokenProvider"));
        }

        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<ClinicaVeterinariaContext>()));
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
            ...
            IOwinContext context)
        {
            var manager = new ApplicationRoleManager(
                new RoleStore<ApplicationRole>(context.Get<ClinicaVeterinariaContext>()));
            return manager;
        }
    }
